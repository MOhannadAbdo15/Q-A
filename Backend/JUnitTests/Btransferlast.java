...
public class Btransferlast {
    ...
    public void transferlasttest() { 
        ...
        assertEquals("Transfer transaction cannot be last\n", outContent.toString());
    }

    public static junit.framework.Test suite(){
       return new JUnit4TestAdapter(Btransferlast.class);
    }
}