...
public class Bdeletenotadmin {
    ...
    @Test
    public void deletenotadmintest() { 
        ...
        assertEquals("ERROR: Attempting to delete without admin credentials\n", outContent.toString());
    }

    public static junit.framework.Test suite(){
       return new JUnit4TestAdapter(Bdeletenotadmin.class);
    }
}