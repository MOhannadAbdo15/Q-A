...
public class Bdisabledisabled {
    ...
    @Test
    public void disabledisabledtest() { 
        ...
        assertEquals("ERROR: Attempting to disable a disabled account\n", outContent.toString());
    }

    public static junit.framework.Test suite(){
       return new JUnit4TestAdapter(Bdisabledisabled.class);
    }
}