...
public class Benableenabled {
    ...
    public void enableenabledtest() { 
        ...
        assertEquals("ERROR: Attempting to enable an enabled account\n", outContent.toString());
    }

    public static junit.framework.Test suite(){
       return new JUnit4TestAdapter(Benableenabled.class);
    }
}